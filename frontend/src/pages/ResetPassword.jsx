...
// T9-formulaires — déclaré au niveau module (pas dans ResetPassword()) :
// défini à l'intérieur, une nouvelle identité de fonction était créée à
// chaque frappe (setForm → re-render), ce qui démontait/remontait l'input
// et faisait perdre le focus après chaque caractère.
const PwdInput = ({ name, placeholder, label, showPwd, setShowPwd, form, setForm }) => (
          ...
          {success ? (
            ...
            <>
              ...
              <form onSubmit={handleSubmit}>
                <PwdInput name="password" placeholder="Nouveau mot de passe" label="Nouveau mot de passe" showPwd={showPwd} setShowPwd={setShowPwd} form={form} setForm={setForm}/>
                ...
                <PwdInput name="confirm" placeholder="Confirmer le mot de passe" label="Confirmer le mot de passe" showPwd={showPwd} setShowPwd={setShowPwd} form={form} setForm={setForm}/>
