...
// ─── DEMO DATA ─────────────────────────────────────────────
const DEMO_EXAMENS = [
  { _id:"1", numero:"IMG-2025-0001", patient_nom:"Jean Dupont", patient_dob:"1975-04-12", sexe:"homme", telephone:"+242 06 123 4567", medecin_prescripteur:"Dr. Martin Leblanc", service_demandeur:"Chirurgie", priorite:"normale", motif:"Bilan préopératoire hernie inguinale", type_categorie:"echographie", type_examen:"Échographie abdominale", statut:"realise", date_demande:"2025-05-28", date_rdv:"2025-05-31", heure_rdv:"09:30", salle:"Salle 1 — Échographie", operateur:"Dr. Amina Diallo", date_realisation:"2025-05-31", observations:"Exploration satisfaisante de tous les quadrants", conclusion:"Pas d'anomalie échographique détectée. Hernie inguinale confirmée cliniquement.", recommandations:"Corrélation clinique recommandée", radiologue:"Dr. Amina Diallo", date_validation:"2025-05-31", images:[], reduction:0, assurance:0 },
  { _id:"2", numero:"IMG-2025-0002", patient_nom:"Marie Paul", patient_dob:"1988-11-03", sexe:"femme", telephone:"+242 05 987 6543", medecin_prescripteur:"Dr. Sophie Pierre", service_demandeur:"Gynécologie", priorite:"urgente", motif:"Douleurs pelviennes aiguës", type_categorie:"echographie", type_examen:"Échographie pelvienne", statut:"en_attente", date_demande:"2025-06-01", date_rdv:"2025-06-02", heure_rdv:"10:00", salle:"Salle 1 — Échographie", operateur:"Dr. Amina Diallo", date_realisation:"", observations:"", conclusion:"", recommandations:"", radiologue:"", date_validation:"", images:[], reduction:0, assurance:0 },
  { _id:"3", numero:"IMG-2025-0003", patient_nom:"Paul Nguema", patient_dob:"1962-07-22", sexe:"homme", telephone:"+242 06 555 0011", medecin_prescripteur:"Dr. Martin Leblanc", service_demandeur:"Urgences", priorite:"tres_urgente", motif:"Suspicion occlusion intestinale", type_categorie:"scanner", type_examen:"Scanner abdominal", statut:"valide", date_demande:"2025-05-28", date_rdv:"2025-05-28", heure_rdv:"14:00", salle:"Salle Scanner", operateur:"Dr. Pierre Mouanda", date_realisation:"2025-05-28", observations:"Examen réalisé avec injection de produit de contraste iodé", conclusion:"Occlusion grêlique confirmée — Niveau de jonction iléo-colique", recommandations:"Intervention chirurgicale en urgence", radiologue:"Dr. Pierre Mouanda", date_validation:"2025-05-28", images:[], reduction:0, assurance:10000 },
  { _id:"4", numero:"IMG-2025-0004", patient_nom:"Fatou Bongo", patient_dob:"1995-02-14", sexe:"femme", telephone:"+242 05 222 3344", medecin_prescripteur:"Dr. Sophie Pierre", service_demandeur:"Médecine générale", priorite:"normale", motif:"Bilan thyroïdien", type_categorie:"echographie", type_examen:"Échographie thyroïdienne", statut:"programme", date_demande:"2025-06-01", date_rdv:"2025-06-05", heure_rdv:"08:30", salle:"Salle 1 — Échographie", operateur:"Dr. Amina Diallo", date_realisation:"", observations:"", conclusion:"", recommandations:"", radiologue:"", date_validation:"", images:[], reduction:0, assurance:0 },
  { _id:"5", numero:"IMG-2025-0005", patient_nom:"André Mboula", patient_dob:"1950-09-18", sexe:"homme", telephone:"+242 06 777 8899", medecin_prescripteur:"Dr. Martin Leblanc", service_demandeur:"Chirurgie", priorite:"normale", motif:"Suivi post-opératoire résection colique", type_categorie:"radiologie", type_examen:"Radio thorax", statut:"valide", date_demande:"2025-04-16", date_rdv:"2025-04-17", heure_rdv:"11:00", salle:"Salle Radiologie", operateur:"Dr. Pierre Mouanda", date_realisation:"2025-04-17", observations:"Clichés de bonne qualité technique", conclusion:"Poumons clairs. Pas d'anomalie pleurale ni parenchymateuse.", recommandations:"Pas d'examen complémentaire nécessaire", radiologue:"Dr. Pierre Mouanda", date_validation:"2025-04-17", images:[], reduction:5000, assurance:0 },
];

const DEMO_MOIS = ["Jan","Fév","Mar","Avr","Mai","Jun","Jul","Aoû","Sep","Oct","Nov","Déc"];
const DEMO_DATA  = [8, 12, 10, 15, 18, 14, 9, 6, 11, 16, 13, 19];
