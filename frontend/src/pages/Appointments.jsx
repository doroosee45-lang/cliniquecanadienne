    ...
    <>
      ...
      <div className="rdv">
        ...
        <Hero
          icon={Calendar}
          title="Rendez-vous"
          dateLabel={`${kpis.aujourd_hui} RDV aujourd'hui · ${kpis.en_salle} en salle · Clinique Canadienne de Souanké`}
          right={
            <>
              <button className="hero-btn-ghost" onClick={() => setModalNotif(true)}>
                <Bell size={14} /> Notifications
              </button>
              <Button icon={Plus} onClick={() => { setFormRdv(makeEmptyRdv()); setModalNouv(true); }}>Nouveau rendez-vous</Button>
            </>
          }
        />
        ...
        <div className="tab-bar" style={isMobile ? {
          ...
          {[
            ...
            <button
              ...
              style={isMobile ? {
                flexDirection:'column', textAlign:'center', padding:'7px 4px 8px',
