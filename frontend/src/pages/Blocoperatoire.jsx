...
function Modal({ open, onClose, title, children, maxWidth = 680 }) {
  ...
  return (
    <div className="bov" onClick={e => e.target === e.currentTarget && onClose()}>
      <div ref={boxRef} className="bov-box" style={{ maxWidth }} role="dialog" aria-modal="true" aria-labelledby={titleId} tabIndex={-1}>
        <div className="bov-hdr">
          <h3 id={titleId}>{title}</h3>
          <button className="bov-cls" onClick={onClose} aria-label="Fermer">×</button>
        </div>
