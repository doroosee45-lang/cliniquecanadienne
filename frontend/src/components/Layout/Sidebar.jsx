...
const NAV_SECTIONS = [
  ...
  },
  {
    ...
    label: 'Clinique',
    items: [
      // FE-INFRA-03 (correction du 12 sept. 2026, audit indépendant) —
      // aligné sur patients.routes.js::CAN_READ (backend, App.jsx::
      // ROLES.patients) : sage_femme/laborantin/radiologue/pharmacien/
      // comptable avaient déjà un accès backend réel au dossier patient
